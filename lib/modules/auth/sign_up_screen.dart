          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPhoneField().animate().fadeIn(delay: 200.ms, duration: 400.ms).slideY(begin: 0.1),
                      ...
                      child: Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(text: 'I agree to HadiKid\'s '),
                              TextSpan(
                                text: 'Terms & Conditions and Privacy Policy',
                                style: AppTextStyles.buttonText.copyWith(color: const Color(0xFF3B8677)),
                              ),
                            ],
                          ),
                        ),
